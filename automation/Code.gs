...
const SPREADSHEET_ID = '1wsoMaptCkNsLah4KkFvdEB_t-saLRYZbQiREeU2rpWE';
...
Return ONLY a valid JSON array — no other text, no markdown, no code fences. Each object:
{
  ...
  "board": one of ["content ideas for small business", "how to write social media captions", "social media tips for small business", "done for you marketing for small business", "marketing strategy for small business", "facebook marketing for small business", "instagram marketing tips"],
  "week": integer 1-4,
  "slot": integer 1-5
}
